...
These are the values that can be easily changed from inside the game:

- Secondary Lifesteal (%): 15% (default)
- Eviscerate Barrier HP (%): 15% (default)
- M1 Attack Speed Fix: True (default)
- M2 Attack Speed Ignore: True (default)
- Focused Assault Damage (%): 700% (vanilla)
- Focused Assault Cooldown (s): 8s (vanilla)
- Eviscerate Damage (%): 110% (vanilla)
- Eviscerate Cooldown (s): 6s (vanilla)
- Blinding Assault Damage (%): 300% (vanilla)
- Blinding Assault Cooldown (s): 5s (default)

## Credits

- [Codedly](https://thunderstore.io/package/codedly/): [MercenaryTweaks](https://thunderstore.io/package/codedly/MercenaryTweaks/) code.
- [@cattonaut](https://www.instagram.com/cattonaut/) (Instagram): mod [icon](https://cattonaut.artstation.com/projects/0na1Aw?album_id=918651).
